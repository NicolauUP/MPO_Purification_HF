...
# The modulation wave number is intentionally unchanged from the 128x128
# validation. Enlarging the lattice refines reciprocal-space sampling without
# changing the physical C8 hopping field.
...
campaign = CampaignSpec(
    name="c8_quasicrystal_lside11_tau_sqrt2_over8_mpo_sp2",
    cases=[CaseSpec(
        label="c8_tau_sqrt2_over8_l2048_u2_v01_chi256",
        model=SquareModel(
