...
# Large simple-C8 hopping-modulation calculation. The modulation, boundary
# convention, and solver policy are inherited from the converged 128x128 C8
# calculation; only size and the conservative MPO cap are increased.
...
campaign = CampaignSpec(
    name="c8_quasicrystal_lside11_tau_sqrt2_over8_mpo_sp2_chi512",
    cases=[CaseSpec(
        label="c8_tau_sqrt2_over8_l2048_u2_v01_chi512",
        model=SquareModel(
            size=(2048, 2048), hopping=c8_hopping(0.1), interaction=2.0,
