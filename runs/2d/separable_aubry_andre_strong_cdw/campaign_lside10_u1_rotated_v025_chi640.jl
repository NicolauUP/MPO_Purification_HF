...
# Intermediate non-separable rotated hopping: U=1 and V2=0.25.
...
campaign = CampaignSpec(
    name="rotated_aubry_andre_strong_cdw_lside10_u1_v025_chi640",
    cases=[
        CaseSpec(
            label="v2_0p25_u_1_theta_pi4_seed_plus2_chi_640",
            model=SquareModel(
                size=(1024, 1024), hopping=rotated_hopping(0.25),
