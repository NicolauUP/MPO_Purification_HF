...
# Conference production calculation: separable quasiperiodic hopping at the
# same physical parameters and numerical policy as the validated 1024^2 rank
# ladder. Only the lattice size is increased to 2048 x 2048.
...
campaign = CampaignSpec(
    name="separable_aubry_andre_v2_0p1_u_1_lside11_mpo_sp2_chi512",
    cases=[CaseSpec(
